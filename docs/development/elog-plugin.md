...
of subclassing `ElogAdapter` and registering it.
...
[`tests/test_services/test_elog_plus.py`](https://github.com/slaclab/react-squirrel-backend/blob/main/tests/test_services/test_elog_plus.py):
construct the adapter against an `httpx.MockTransport` so tests stay
hermetic. Route-level tests can use
[`tests/mocks/elog_mock.py::MockElogAdapter`](https://github.com/slaclab/react-squirrel-backend/blob/main/tests/mocks/elog_mock.py)
