...
class TestTagGroupCreate:
    ...
    async def test_create_tag_group(self, client: AsyncClient):
        ...
        response = await client.post("/v1/tags", json={
            "name": "Location",
            "description": "Physical location tags"
        })
    ...
    @pytest.mark.asyncio
    async def test_create_tag_group_duplicate_name_fails(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
        """Test that duplicate group names are rejected."""
        response = await client.post("/v1/tags", json={
            "name": sample_tag_group["name"]  # Duplicate name
        })
...
class TestTagGroupGet:
    ...
    @pytest.mark.asyncio
    async def test_get_all_tag_groups(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_tag_group_by_id(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
...
class TestTagGroupUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_tag_group_name(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
        ...
        group_id = sample_tag_group["id"]
        response = await client.put(f"/v1/tags/{group_id}", json={
    ...
    @pytest.mark.asyncio
    async def test_update_tag_group_description(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
    ...
    async def test_update_tag_group_not_found(self, client: AsyncClient):
        ...
        response = await client.put("/v1/tags/nonexistent-id", json={
            "name": "Should Fail"
        })
...
class TestTagGroupDelete:
    ...
    @pytest.mark.asyncio
    async def test_delete_tag_group(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
...
class TestTagOperations:
    ...
    @pytest.mark.asyncio
    async def test_add_tag_to_group(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
        ...
        group_id = sample_tag_group["id"]
        response = await client.post(f"/v1/tags/{group_id}/tags", json={
            "name": "Building-A",
            "description": "Building A location"
        })
    ...
    @pytest.mark.asyncio
    async def test_add_multiple_tags_to_group(
        self,
        client: AsyncClient,
        sample_tag_group: dict
    ):
    ...
    async def test_add_tag_to_nonexistent_group(self, client: AsyncClient):
        ...
        response = await client.post("/v1/tags/nonexistent-id/tags", json={
            "name": "Should Fail"
        })
    ...
    async def test_update_tag(
        ...
        response = await client.put(f"/v1/tags/{group_id}/tags/{tag_id}", json={
    ...
    async def test_update_tag_not_found(
        ...
        group_id = sample_tag_group["id"]
        response = await client.put(f"/v1/tags/{group_id}/tags/nonexistent-tag", json={
            "name": "Should Fail"
        })
